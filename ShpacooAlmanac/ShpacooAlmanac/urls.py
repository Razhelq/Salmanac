...
from shpacoo_portal.views import TestView, UserCreateView, LoginView, AddArtistView, DisplayAlbumsView, \
    IndexView, DeleteArtistView, FindAlbumsView, LogoutBiew
